		...
		<>
			<div className='mx-auto h-screen bg-yellow-300'>
				...
				<div className='mt-10 flex flex-col md:flex-row justify-center content-around gap-8 px-8 md:px-0'>
					<button class='bg-blue-500 hover:bg-blue-700 text-white font-bold text-md py-4 px-8 rounded-full'>
			...
			<div data-aos='fade-up' className='container mx-auto pt-24 pb-24 px-8'>
				...
				<p className='text-center text-xl md:w-[48rem] mx-auto'>
					...
					<span> Ukraine ❤</span>, regardless of their nationality, racial or ethnic
					origin, or how they identify themselves.
				</p>
				...
				<p className='text-center text-xl md:w-[48rem] mx-auto mt-2'>
					...
					, or make a donation that will help finance the stays of those who need it
					most.
				</p>
			</div>
				...
				>
					<div className='flex-initial w-64'>
						<p className='text-center text-4xl pt-24'>
							...
							<span className='text-blue-500'>Shelter</span>, join us and find a host
							or become one.
						</p>
					</div>
						...
						>
							<div class='px-6 py-4'>
								...
								<p class='text-gray-700 text-base'>
									Make sure your guests have a comfortable bed and basic amenities during
									their stay, which can last from a few days to several weeks.
								</p>
							</div>
						</div>
					</div>
							...
							>
								<div class='px-6 py-4 '>
									...
									<p class='text-gray-700 text-base'>
										...
										<span className='text-blue-500'>Shelter</span> partners with nonprofit
										organizations that check refugee guests for eligibility and offer help
					...
					<div data-aos='fade-right' className='flex-1'>
						<div class='max-w-sm rounded overflow-hidden shadow-lg'>
							<div class='px-6 py-4'>
								...
								<p class='text-gray-700 text-base'>
									Every penny will be used to find and offer temporary accommodation to
									people in need.
								</p>
							</div>
						</div>
						...
						<div className='flex-1'>
							...
							>
								<div class='px-6 py-4'>
									...
									<p class='text-gray-700 text-base'>
										You will be able to deduct the donations you make when the local
										legislation in your area allows it.
									</p>
								</div>
							</div>
						</div>
